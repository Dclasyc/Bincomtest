...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2022 at 01:25 PM
...
CREATE TABLE `results` (
  ...
  `polling_unit` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `party` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `result` bigint(255) NOT NULL,
...
INSERT INTO `results` (`id`, `polling_unit`, `party`, `result`, `created_at`, `updated_at`) VALUES
(1, 'Sapele Primary School', 'Labour', 456, '2022-12-31 11:45:29', '2022-12-31 11:45:29');
